...
if st.button("Delete Student"):
    sdk.student.delete(id="0b960c7d-ba8d-4ec1-942c-54b8ec08175e")
...
if st.button("Patch Student"):
    sdk.student.patch(
        id="0b960c7d-ba8d-4ec1-942c-54b8ec08175e",
...
if st.button("Get Student Summary"):
    sdk.student.getStudentSummary(id="a2278689-7812-425d-a604-de27322cc2c1")
...
installation_id = st.query_params.get("installationId")

if installation_id:
    if st.button("Get Installation Config"):
        sdk.pluginInstallation.detail(installation_id)

    pluginInstallation = sdk.pluginInstallation.response(
        action="detail",
    )

    if pluginInstallation:
        st.write(pluginInstallation)
